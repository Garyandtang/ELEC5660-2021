...
bool Estimator::inputImage(ros::Time time_stamp, const cv::Mat& _img, const cv::Mat& _img1) {
  ...
  c_R_k.setIdentity(); // this is current cam to key frame, the comment in estimator.h is wrong
  c_t_k.setZero(); // this is current cam to key frame, the comment in estimator.h is wrong 
